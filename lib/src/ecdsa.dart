...
class Ecdsa {
  ...
  static String sign(SignParams params) {
    final result = ecdsa_sign(params.toJson().toNativeUtf8());
    final signature =
        Response.fromJson(result.cast<Utf8>().toDartString()).handleResponse();
